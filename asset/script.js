$(document).ready(function () {
    // use api key inorder to get forecast data
    ...
    let query ="";
      ...
      if (input.id === "getWeather"){ 
         location = $('#city-search').val()
        } 
       else if ( input.className === ("cityList") ) {
        location = input.innerText;
      }
      if (location == "") 
      return;
     ...
     function convertDate(period) {
      let readable = [];
      let myDate = new Date(period * 1000);
